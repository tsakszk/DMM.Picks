...
50.times do |n|
  ...
  sex_random = rand(sexes.length)
  sex = sexes[sex_random]
...
# about
abouts_status = ["unanswered","answering","answered"]
About.create!(subject: "subject")
About.create!(body: "body")

# categorys
categorys = ["people", "culture", "other"]

# hamburgers
hamburgers_name = ["mypicks", "source", "setting", "about", "logout"]
